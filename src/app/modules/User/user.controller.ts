...
// *! update user role and account status
const changeNotificationStatus = catchAsync(async (req: Request, res: Response) => {
  const result = await userService.changeNotificationStatus( req.user.id);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
...
const deleteUsersWithRelations = catchAsync(async (req: Request, res: Response) => {
  const result = await userService.deleteUsersWithRelations(req.body.userIds);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
